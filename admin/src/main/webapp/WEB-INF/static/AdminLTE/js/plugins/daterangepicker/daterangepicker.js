...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.applyClass = 'btn-danger btn-sm';
        this.cancelClass = 'btn-default btn-sm';
        ...
        //this.container.find(".daterangepicker_end_input").style("display","none");
    ...
    DateRangePicker.prototype = {
        ...
        clickApply: function (e) {
            ...
            if(this.applyCallback){
            	this.applyCallback(this.startDate, this.endDate);
            }
            this.hide();
        },
