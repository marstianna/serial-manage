(function (root, factory) {
    ...
    Rickshaw.Graph.Annotate = function (args) {
        ...
        this.elements = {intimeline: args.element};
        var self = this;
        this.data = {};
        this.elements.intimeline.classList.add("rickshaw_annotation_intimeline");
        ...
        this.update = function () {
            Rickshaw.keys(self.data).forEach(function (time) {
                ...
                if (!annotation.element) {
                    ...
                    this.elements.intimeline.appendChild(element);
